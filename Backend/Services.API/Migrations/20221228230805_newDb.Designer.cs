...
namespace Services.API.Migrations
{
    ...
    [Migration("20221228230805_newDb")]
    partial class newDb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderDetailOrderedGamesDetail", b =>
                {
                    b.Property<int>("OrderedGamesGameId")
                        .HasColumnType("int");

                    b.Property<int>("OrdersOrderNum")
                        .HasColumnType("int");

                    b.HasKey("OrderedGamesGameId", "OrdersOrderNum");

                    b.HasIndex("OrdersOrderNum");

                    b.ToTable("OrderDetailOrderedGamesDetail");
                });
            ...
            modelBuilder.Entity("OrderDetailOrderedGamesDetail", b =>
                {
                    b.HasOne("App.Library.OrderedGamesDetail", null)
                        .WithMany()
                        .HasForeignKey("OrderedGamesGameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
